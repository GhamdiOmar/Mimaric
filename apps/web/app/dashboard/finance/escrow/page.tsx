...
import { Landmark, RefreshCw, ChevronLeft } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <KPICard label={lang === "ar" ? "إجمالي حسابات الضمان" : "Total Escrow Accounts"} value="0" accentColor="primary" icon={<Landmark className="h-5 w-5" />} />
